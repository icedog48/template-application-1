using $ext_projectname$.NhibernateRepositories.Helpers;
using $safeprojectname$.Infrastructure.Formatters;
using $safeprojectname$.Infrastructure.OAuth2.ServerProviders;
using Autofac;
